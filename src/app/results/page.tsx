        ...
        <CardContent className="px-2 pb-2">
          {isExpanded && (
            <div className="mt-4 space-y-4 mb-1">
              {sections.map((sectionData: any) => (<CourseCard course={course} section={sectionData.section.properties} status={sectionData.status} onTouch={DisplayClassInfo} modal={openModal} modal2={openPrereqModal}/>))}
            </div>
          )}
        </CardContent>
      </Card>
